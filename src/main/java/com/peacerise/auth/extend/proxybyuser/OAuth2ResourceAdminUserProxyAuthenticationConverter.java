...
import com.peacerise.auth.extend.proxybyuser.utils.OAuth2EndpointUtils;
...
public final class OAuth2ResourceAdminUserProxyAuthenticationConverter implements AuthenticationConverter {
    ...
    public Authentication convert(HttpServletRequest request) {
        ...
        if (!OAuth2ResourceAdminUserProxyAuthenticationProvider.PROXY_BY_USER.equals(grantType)) {
            return null;
        }
